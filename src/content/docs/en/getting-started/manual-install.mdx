...
You can also [open the Compose file in the browser](/install/docker-compose.manual.yml) before downloading it. Review the images, ports, volumes, health checks, log limits, and Docker socket mount. The file is configuration; it is not executed by the shell.
