...
| Scope | Description | Restrictions | Tokens |
| --- | --- | --- | --- |
| `integrations:gitlab:view` | View configured GitLab connectors, sync status, and synced projects | — | API, MCP |
| `integrations:gitlab:manage` | Create, edit, rotate, sync, and delete GitLab connectors | — | API, MCP |
| `integrations:gitlab:use` | Use the connector credential for otherwise permitted GitLab operations | — | API, MCP |
| `integrations:gitlab:repo:read` | Read repository files, CI pipelines and job logs, and CI/CD variable keys (never values) through GitLab connectors | — | API, MCP |
| `integrations:gitlab:repo:write` | Change repository files, CI configuration, CI/CD variables, webhooks, and registry records through GitLab connectors | — | API, MCP |
| `integrations:gitlab:sandbox:clone` | Clone allowed GitLab repositories into AI sandboxes | — | — |
...
| `integrations:github:manage` | Create, edit, rotate, sync, and delete GitHub token connectors | — | API, MCP |
| `integrations:github:use` | Use the connector credential instead of a personal GitHub authorization | — | API, MCP |
| `integrations:github:repo:read` | List repositories and read files through GitHub connectors (no Actions variable values) | — | API, MCP |
| `integrations:github:repo:write` | Change repository files and secrets, and read or change Actions variables, through GitHub connectors | — | API, MCP |
...
| `integrations:git:manage` | Create, edit, rotate, sync, and delete generic Git connectors | — | API, MCP |
| `integrations:git:use` | Use the connector credential instead of a personal Git authorization | — | API, MCP |
| `integrations:git:repo:read` | List repositories and read files through generic Git connectors | — | API, MCP |
| `integrations:git:repo:write` | Change repository files through generic Git connectors | — | API, MCP |
