...
Gateway defines 245 permission scopes. The tables below list their exact names and the actions they authorize. Assign permissions through groups or a user's additional permissions; see [users and groups](/en/identity/auth-users-groups/) and [API tokens, OAuth, and MCP](/en/identity/scopes-tokens-oauth/) for setup.
...
| `proxy:raw:write` | Edit raw nginx configuration | Resource, Folder | API, MCP |
| `proxy:raw:toggle` | Switch between managed and raw config mode | Resource, Folder | API, MCP |
| `proxy:raw:bypass` | Save raw nginx config without dangerous directive restrictions | Resource, Folder | API, MCP |
| `proxy:advanced` | Use advanced proxy configuration | Resource, Folder | API, MCP |
| `proxy:advanced:bypass` | Save unrestricted advanced nginx snippets | Resource, Folder | API, MCP |
...
| `nodes:config:edit` | Edit node nginx configuration | Resource, Folder | API, MCP |
...
| `integrations:gitlab:manage` | Create, edit, rotate, and delete GitLab connectors | — | API, MCP |
| `integrations:gitlab:sync` | Refresh projects and registries using the connector credential | — | API, MCP |
| `integrations:gitlab:system` | Use the connector credential for otherwise permitted GitLab operations | — | API, MCP |
...
| `integrations:gitlab:repo:write` | Commit file changes through GitLab connectors | — | API, MCP |
| `integrations:gitlab:ci:view` | View GitLab CI pipelines and configuration | — | API, MCP |
| `integrations:gitlab:ci:edit` | Lint and update GitLab CI configuration | — | API, MCP |
| `integrations:gitlab:variables:view` | View GitLab variable metadata without secret values | — | API, MCP |
| `integrations:gitlab:variables:edit` | Create and update GitLab project variables | — | API, MCP |
| `integrations:gitlab:variables:delete` | Delete GitLab project variables | — | API, MCP |
| `integrations:gitlab:webhooks:manage` | Create, update, and delete GitLab project webhooks | — | API, MCP |
| `integrations:gitlab:registry:manage` | Manage GitLab registry integration records and deploy credentials | — | API, MCP |
...
| `integrations:github:sync` | Re-validate GitHub connectors and their repository allowlist using the connector credential | — | API, MCP |
| `integrations:github:manage` | Create, edit, rotate, and delete GitHub token connectors | — | API, MCP |
| `integrations:github:system` | Use the connector credential instead of a personal GitHub authorization | — | API, MCP |
...
| `integrations:git:sync` | Re-validate generic Git connectors and their repository allowlist using the connector credential | — | API, MCP |
| `integrations:git:manage` | Create, edit, rotate, and delete generic Git connectors | — | API, MCP |
| `integrations:git:system` | Use the connector credential instead of a personal Git authorization | — | API, MCP |
...
| `storage:credentials:use` | Let backups use saved storage credentials without revealing them | Resource, Folder | API, MCP |
| `storage:iam` | Create and revoke managed storage access keys and workload bindings | Resource, Folder | API, MCP |
