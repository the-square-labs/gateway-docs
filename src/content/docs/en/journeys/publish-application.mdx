...
If this is your first deployment, prepare a [Docker Node](/en/getting-started/first-node/), review the [Docker resource models](/en/docker/overview/), and keep [Publish your first Route](/en/getting-started/first-route/) open for the ingress step.
...
| --- | --- | --- |
| Workload never becomes ready | Owning Task, application logs, port, and health check | [Docker overview](/en/docker/overview/) |
| Route does not publish | DNS, TLS, nginx apply, Route health, and upstream | [Ingress troubleshooting](/en/ingress/troubleshooting/) |
| Secure Link is unavailable | Both Nodes, Relay, target workload, and connector operation | [Secure upstreams](/en/ingress/secure-upstreams/) |
| New release is unhealthy | Roll back the owning workload; keep the Route intact | [Blue-green Deployments](/en/docker/deployments/) |
| Migration changed data | Stop writes and follow the separate data-recovery plan | [Updates and backups](/en/operations/updates-backups/) |
