...
flowchart TB
    ...
    gateway <-->|"Internal authenticated gRPC"| relay["Gateway Relay<br/>TCP 9443"]
    daemons["Managed hosts<br/>nginx · Docker · Databases · Build Worker · Monitoring"] -->|"Outbound authenticated sessions"| relay
```
