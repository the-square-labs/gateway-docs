...
Every official release also carries the [Product Continuity MIT Grant](https://github.com/the-square-labs/gateway/blob/main/CONTINUITY-MIT-GRANT.md). Product pauses, discontinued support or sales, public announcements, and website or licensing-service outages do not trigger MIT. Its automatic terms apply only if the relevant rights are held by a company that is finally dissolved and remains without a successor or assignee for 90 days, or through an express voluntary MIT election by the current rights holder. Trademarks, commercial keys, separately licensed documentation and assets, and third-party code remain outside that grant.
