...
The current source owned by Alexandr Slavinschii, operating the project under the Square Labs name, is available under [PolyForm Perimeter 1.0.1](https://github.com/the-square-labs/gateway/blob/main/LICENSE.md). The Square Labs OÜ becomes the rights holder only after registration in Estonia and an effective written assignment. PolyForm Perimeter permits use, modification, and redistribution for noncompeting purposes, including ordinary internal business use. The excluded purpose is providing others with a product marketed as a substitute for Gateway, whether as software, a hosted service, a port, or a free offering.
...
Every official release also carries the [Product Continuity MIT Grant](https://github.com/the-square-labs/gateway/blob/main/CONTINUITY-MIT-GRANT.md). It has no release-age or inactivity countdown. Product pauses, discontinued support or sales, public announcements, and website or licensing-service outages do not trigger MIT. Before registration of The Square Labs OÜ and an effective written assignment, no automatic transition applies. After assignment, the conditional MIT terms can start only 90 days after final legal dissolution without a successor or assignee, or through an express voluntary MIT election by the current rights holder. Trademarks, commercial keys, separately licensed documentation and assets, and third-party code remain outside that grant.
