...
Other categories cover nginx logs, dismissed alerts, notification deliveries, structured logs, ClickHouse system tables, orphaned AI artifacts, the internal registry, orphaned volumes, retired system PKI keys, ACME challenge files, and old Gateway images.
