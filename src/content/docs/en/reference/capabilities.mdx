...
- **Storage — available in 2.11**, Personal and higher: connections to S3-compatible, FTP, FTPS, and SFTP storage, and managed MinIO object storage with private workload links and Secure Links. See [Storage](/en/storage/overview/).
...
- **Storage (Personal and higher):** S3-compatible, FTP, FTPS, and SFTP connections with an object browser, and managed MinIO object storage with access keys, private workload links, and optional public listeners.
