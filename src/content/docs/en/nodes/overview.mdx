...
To create VMs directly from Gateway, see [Hosting providers](/en/integrations/hosting-providers/). Connected accounts appear under **Nodes > Providers**. The guide covers VM power, firewall, snapshots, and billing permissions.
