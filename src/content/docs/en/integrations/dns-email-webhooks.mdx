...
For DNS connector setup, follow the dedicated [Cloudflare guide](/en/integrations/cloudflare/). Email and notification or deployment webhooks are separate integration surfaces, not hosting accounts.
