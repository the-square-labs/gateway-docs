...
| License key ordinarily expires, or a paid plan is downgraded, revoked, or deactivated | everything during the grace period (none for revocation, transfer, or deactivation); after it, existing workloads, the data plane, data, scheduled backups, and viewing, monitoring, and deletion of existing paid resources | creating paid resources and changing their configuration; SIEM forwarding and external registry tokens pause until renewal; see [Downgrade and expiry](/en/reference/plans-and-entitlements/#downgrade-and-expiry) |
| License service unreachable | Gateway, workloads, and paid features continue; a previously valid paid key stays valid for 100 days after its last signed license state | activating a key and updating Gateway on any plan; after 100 days, the after-grace rules of an ordinary expiry |
